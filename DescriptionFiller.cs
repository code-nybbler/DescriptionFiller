...
namespace DescriptionFiller
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
        ExportMetadata("Name", "Description Filler"),
        ExportMetadata("Description", "Allows users to quickly set generic, context-based descriptions for various components"),
    ...
    public class DescriptionFiller : PluginBase
    {
        public override IXrmToolBoxPluginControl GetControl()
        {
            return new DescriptionFillerControl();
        }

        /// <summary>
        /// Constructor 
        /// </summary>
        public DescriptionFiller()
        {
